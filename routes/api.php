...
Route::middleware(['auth:sanctum', \App\Http\Middleware\CheckCrudPermissions::class])->group(function () {
    ...
    Route::get('/inventario/hospital/{hospitalId}/por-vencer', [\App\Http\Controllers\InventarioController::class, 'listarPorVencerPorHospital'])
    ...
    Route::get('/movimientos-stock/historial/origen/{origen_sede_id}', [MovimientoStockController::class, 'historialPorOrigenSede'])
    ...
    Route::put('/ficha-insumos', [FichaInsumoController::class, 'updateMany']);
